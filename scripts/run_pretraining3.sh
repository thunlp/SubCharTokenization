...
DATASET=data/baike/hdf5sp_wubi_zh_30k_sep
DATA_DIR_PHASE1=${21:-$DATASET}
BERT_CONFIG=bert_config_vocab30k.json
...
CHECKPOINTS_DIR=$RESULTS_DIR/checkpoints_wubi_zh
...
CMD="python3 -m torch.distributed.launch --master_port=6234 --nproc_per_node=$num_gpus $CMD"
...
CMD="python3 -m torch.distributed.launch --master_port=6235 --nproc_per_node=$num_gpus $CMD"
