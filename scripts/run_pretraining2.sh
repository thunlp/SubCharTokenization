...
DATASET=data/baike/hdf5sp_raw_zh_15k
DATA_DIR_PHASE1=${21:-$DATASET}
BERT_CONFIG=bert_config_vocab15k.json
...
CHECKPOINTS_DIR=$RESULTS_DIR/checkpoints_raw_zh_15k
...
CMD="python3 -m torch.distributed.launch --master_port=2234 --nproc_per_node=$num_gpus $CMD"
...
CMD="python3 -m torch.distributed.launch --master_port=2235 --nproc_per_node=$num_gpus $CMD"
