...
DATASET=data/baike/hdf5bert_chinese_uncased_22675
DATA_DIR_PHASE1=${21:-$DATASET}
BERT_CONFIG=bert_config_vocab22675.json
...
CHECKPOINTS_DIR=$RESULTS_DIR/checkpoints_bert_zh_22675
...
CMD+=" $INIT_CHECKPOINT"
CMD+=" --do_train --resume_from_checkpoint"
CMD+=" --json-summary ${RESULTS_DIR}/dllogger.json "

CMD="python3 -m torch.distributed.launch --master_port=4234 --nproc_per_node=$num_gpus $CMD"
...
CMD="python3 -m torch.distributed.launch --master_port=4235 --nproc_per_node=$num_gpus $CMD"
